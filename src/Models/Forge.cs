...
namespace SourceGit.Models
{
    ...
    public static class Forge
    {
        ...
        /// <summary>
        ///     The path of a remote URL, cut into segments and decoded.
        ///
        ///     The decoding is the point. <c>Uri.AbsolutePath</c> hands back the escaped path,
        ///     so a repository called "JARVIS - VISION" arrives as "JARVIS%20-%20VISION" --
        ///     and every forge service escapes what it is given, which turns the percent
        ///     itself into %25 and asks for "JARVIS%2520-%2520VISION". The forge then answers
        ///     404 about a repository nobody owns, and the panel simply shows nothing.
        ///
        ///     Decoded per segment and after the split, never before: a %2F inside a name is
        ///     part of that name and must not become a separator.
        /// </summary>
        private static List<string> SplitPath(string path)
        {
            ...
            foreach (var part in path.Split('/', StringSplitOptions.RemoveEmptyEntries))
            {
                ...
                result.Add(name.EndsWith(".git", StringComparison.Ordinal) ? name[..^4] : name);
            }
